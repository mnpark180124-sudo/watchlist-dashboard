...
뉴스와 전자공시를 모두 찾아라. 아래 두 가지를 반드시 따로 검색해라:

1. "{name} 공시" "{name} dart.fss.or.kr" 같은 검색어로 DART 전자공시를 직접 찾아라.
   공시 유형 예시: 실적공시(잠정실적, 매출액또는손익구조30%이상변동), 수주공시, 유상증자, 무상증자,
   자사주취득/처분, 최대주주변경, 신규시설투자, 타법인주식취득, 풍문또는보도에대한해명,
   전환사채/신주인수권부사채 발행 등. 사소해 보여도 "신규시설투자"나 "풍문또는보도에대한해명"처럼
   공식 공시로 나온 건 놓치지 말고 찾아라.
2. "{name} 뉴스"로 국내/해외 일반 뉴스(중앙일보, 한국경제 등 언론사 보도 포함)도 찾아라.

찾았으면 그중 주가에 영향을 줄 만큼 중요한 것이 있는지 판단해라.
